...
import ru.itis.inform.Version1ByArray.FareyGenerate;
import ru.itis.inform.Version1ByArray.RationalNumber;

import static org.junit.Assert.*;


public class FareyModuleTestByFarrey {

    private FareyGenerate fareyArray;

    @org.junit.Before
    public void setUp() throws Exception {
        this.fareyArray = new FareyGenerate();
